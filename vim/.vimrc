...
" Most Recently Used provides an easy access to a list of recently opened/edited files
" Bundle 'vim-scripts/mru.vim'
" Bundle 'Python-2.x-Standard-Library-Reference'
" Bundle 'Python-Documentation'
" Bundle 'pythoncomplete'
" Bundle 'python_calltips'
...
" provides insert mode auto-completion for quotes, parens, brackets, etc
" Autoclose - this plugin breaks the iabbrv definitions
